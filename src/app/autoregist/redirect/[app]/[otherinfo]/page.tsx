...
import { decodeUrl } from '@/app/utillities/function';

export default function AutoRegistDetail({ params }: { params: { app: string, otherinfo: string }}) {
  ...
  const onClickPreRegistButton = async () => {
    try {
      ...
      await createAutoregistInfo(password, params.app, decodeUrl(params.otherinfo));
    ...
    <main className={styles.main}>
      <div className={styles.content}>
        ...
        <div className={styles.detail}>
          ...
          <Caption caption="アカウント名" />
          <ReadonlyTextbox type="text" id="account" placeholder="" val={decodeUrl(params.otherinfo)} onChange={
            // 何も処理しない
            () => {}
          } />
        </div>
